...
def _convert_hf_conll2003_to_document_dataset(
...
def convert_hf_conll2003_to_document_dataset(
    hf_dataset: Union[DatasetDict, IterableDatasetDict],
    entity_layer: str = "entities",
) -> PIEDatasetDict:
    return {
        k: _convert_hf_conll2003_to_document_dataset(v, entity_layer=entity_layer)
...
def load_conll2003(
    ...
    dataset = convert_hf_conll2003_to_document_dataset(hf_dataset=dataset_hf)
