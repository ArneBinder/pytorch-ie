...
class Json(datasets.ArrowBasedBuilder):
    ...
    # def as_dataset(
    #     self, split: Optional[datasets.splits.Split] = None, run_post_process=True, ignore_verifications=False, in_memory=False
    # ) -> Union[datasets.Dataset, datasets.DatasetDict]:

    #     dataset = super().as_dataset(split=split, run_post_process=run_post_process, ignore_verifications=ignore_verifications, in_memory=in_memory)
    ...
    def _as_dataset(self, split: Union[datasets.ReadInstruction, datasets.Split] = datasets.splits.Split.TRAIN, in_memory: bool = False) -> Dataset:
        ...
        dataset_kwargs = datasets.ArrowReader(self._cache_dir, self.info).read(
            name=self.name,
            instructions=split,
