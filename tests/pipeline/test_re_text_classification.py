...
def test_re_text_classification():
    ...
    assert pytest.approx(rel0.score) == 0.9694293737411499
    ...
    assert pytest.approx(rel1.score) == 0.7182475924491882
    ...
    assert pytest.approx(rel2.score) == 0.9422258138656616
    ...
    assert pytest.approx(rel3.score) == 0.8561000823974609
