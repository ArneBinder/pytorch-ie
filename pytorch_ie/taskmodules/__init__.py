...
from pytorch_ie.taskmodules.transformer_text_classification import TransformerTextClassificationTaskModule
from pytorch_ie.taskmodules.transformer_token_classification import TransformerTokenClassificationTaskModule
