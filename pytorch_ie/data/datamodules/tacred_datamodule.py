...
class TacredDataModule(LightningDataModule):
    """
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        train_documents = load_tacred(self.path, split="train")
        val_documents = load_tacred(self.path, split="validation")
        test_documents = load_tacred(self.path, split="test")
        ...
        self.data_test = self.task_module.encode(test_documents, encode_target=True)
