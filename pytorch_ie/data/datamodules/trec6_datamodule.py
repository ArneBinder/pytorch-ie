...
from pytorch_ie.data.datasets.trec import load_trec
from pytorch_ie.taskmodules.taskmodule import TaskEncoding, TaskModule


class Trec6DataModule(LightningDataModule):
    """
    ...
    def __init__(
        ...
        train_val_split: Tuple[int, int] = (4952, 500),
        batch_size: int = 32,
        num_workers: int = 0,
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        train_documents = load_trec(split="train", fine_grained=False)
        test_documents = load_trec(split="test", fine_grained=False)
        ...
        # TODO: fiy mypy: Incompatible types in assignment (expression has type "Subset[<nothing>]", variable has type "Optional[List[TaskEncoding[Any, Any]]]")
