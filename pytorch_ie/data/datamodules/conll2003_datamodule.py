...
class CoNLL2003DataModule(LightningDataModule):
    """
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        train_documents = load_conll2003(split="train")
        val_documents = load_conll2003(split="validation")
        test_documents = load_conll2003(split="test")
